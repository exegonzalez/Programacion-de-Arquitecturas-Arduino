/* 11.  Utilice un magnetómetro para crear una brújula, identifique los distintos puntos cardinales 
con distintos colores y los puntos intermedios variando la tonalidad del led.*/
...
void setup() {
    Serial.begin(9600);
    Serial.println("Inicializando Magnetometro..."); //Inicializamos la comunicación I2C y el magnetómetro
    Wire.begin();
